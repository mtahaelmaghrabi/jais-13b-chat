...
model_path = "C:\\Users\\mohamed\\jais-downloads\\jais-original-repo"
...
print("Before model #############################")
#model = AutoModelForCausalLM.from_pretrained(model_path, device_map="auto", offload_folder="/usr/src/app/model/offload", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained(model_path, device_map="auto", offload_folder="C:\\Users\\mohamed\\jais-downloads\\jais-original-repo\\offload", trust_remote_code=True)
